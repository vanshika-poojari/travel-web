...
<div className="container">
        <div className="carousel">
          <div className="carousel-track">
            ...
            <div className="carousel-item">
              <img className="img-c" src="./src/assets/travel/tr1.jpg" alt="First slide" />
            </div>
            <div className="carousel-item">
              <img className="img-c" src="./src/assets/travel/tr2.jpg" alt="Second slide" />
            </div>
            <div className="carousel-item">
              <img className="img-c" src="./src/assets/travel/tr3.jpg" alt="Third slide" />
            </div>
            <div className="carousel-item">
              <img className="img-c" src="./src/assets/travel/tr4.jpg" alt="Fourth slide" />
            </div>
      ...
      <img className = "img-travel" src = "./src/assets/tr6.jpg" alt = "img" />
