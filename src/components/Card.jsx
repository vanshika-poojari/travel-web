...
const Card = () => {
  return (
    ...
    <div>
        ...
        <div className="card" >
        <img src="./src/assets/Assam1.jpg" className="card-img-top" alt="..." />
      ...
      <div className="card" >
        <img className="card-img-top" src="./src/assets/varanasi.jpeg" alt="..." />
        <div className="card-body">
      ...
      <div className="card" >
        <img src="./src/assets/srinagar.jpeg" className="card-img-top" alt="..." />
        <div className="card-body">
