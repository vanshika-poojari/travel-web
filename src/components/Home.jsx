...
export const Home = () => {
    return (
        <div>
            <div>
                <img className="img" src="./src/assets/img2.jpg" alt="img"></img>
            ...
            <div className="travel">
                ...
                {/* img */}
                <div className="t-img">
                    <img className="img-side" src="./src/assets/img-t.png" alt="img"></img>
                </div>
            </div>
            ...
            <div className="travel1">
                ...
                <div className="t-img1">
                    <img className="img-side1" src="./src/assets/img-ttt.png" alt="img"></img>
                </div>
            </div>
